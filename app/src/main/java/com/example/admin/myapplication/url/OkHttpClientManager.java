package com.example.admin.myapplication.url;
...
//            }
    ...
    public class DownloadDelegate {
         ...
         * @param callback
         */
        public void downloadAsyn(final String url, final String destFileDir, Param[] params, ResultCallback callback, Object tag) {
            Request request;
            if(params == null)
            ...
            mOkHttpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(Response response) {
                    ...
                    try {
                        ...
                        sendSuccessResultCallback(file.getAbsolutePath(), resCallBack);
                    } catch (IOException e) {
                        sendFailedStringCallback(response.request(), e, resCallBack);
                    } finally {
                        try {
        ...
        private Request buildMultipartFormRequest(String url, Param[] params, Object tag) {
            params = validateParam(params);
